...
\textbf{Add A record:} 
Adversary can add  A record subdoamins with IP address pointing to the server under its control. He can spawn unlimited number of subdomains and rotate between them to evade detection. %Adversary can use the business model of the parent domain and can setup subdomains for phishing and exploit kit attack. 
